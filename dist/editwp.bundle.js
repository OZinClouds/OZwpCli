...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/jquery/dist/jquery.js-exposed")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = swal_backup;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__run_db_export_js__ = __webpack_require__("./src/run.db.export.js");
...
function swal_backup(wpPath, DBname){
	swal({
		...
		if(value){
			return Object(__WEBPACK_IMPORTED_MODULE_0__run_db_export_js__["a" /* runDBexport */])(wpPath, DBname, "tmp");
		}
	}).then( (value) => {
		if(value){
			return Object(__WEBPACK_IMPORTED_MODULE_0__run_db_export_js__["a" /* runDBexport */])(wpPath, DBname, "wp");
		} else {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = swal_delete;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__run_bash_js__ = __webpack_require__("./src/run.bash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__run_db_delete_js__ = __webpack_require__("./src/run.db.delete.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__run_db_export_js__ = __webpack_require__("./src/run.db.export.js");




function swal_delete(wpName, wpPath, DBname){
	...
	swal({
		...
		if(value){
			return Object(__WEBPACK_IMPORTED_MODULE_2__run_db_export_js__["a" /* runDBexport */])(wpPath, DBname, "tmp");
		}
	}).then((value)=>{
		if(value){
			return Object(__WEBPACK_IMPORTED_MODULE_1__run_db_delete_js__["a" /* runDBdelete */])(DBname);
		} else {
			swal("oops","DB Export \n something went wrong","error");
		}
	}).then((value)=>{
		if(value){
			return Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("rm -rf "+wpPath);
		} else {
			swal("oops","DB delete \n something went wrong","error");
		}
	}).then((value)=>{
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["LoadEditTab"] = LoadEditTab;
/* harmony export (immutable) */ __webpack_exports__["loadMe"] = loadMe;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__run_wp_lock_js__ = __webpack_require__("./src/run.wp.lock.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__run_finder_js__ = __webpack_require__("./src/run.finder.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__run_wp_config_get_js__ = __webpack_require__("./src/run.wp.config.get.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__run_bash_js__ = __webpack_require__("./src/run.bash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__editwp_backup_js__ = __webpack_require__("./src/editwp.backup.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__editwp_delete_js__ = __webpack_require__("./src/editwp.delete.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__editwp_tab_config_js__ = __webpack_require__("./src/editwp.tab.config.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__editwp_tab_options_js__ = __webpack_require__("./src/editwp.tab.options.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__editwp_tab_plugins_js__ = __webpack_require__("./src/editwp.tab.plugins.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__editwp_tab_themes_js__ = __webpack_require__("./src/editwp.tab.themes.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__editwp_tab_users_js__ = __webpack_require__("./src/editwp.tab.users.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_tablesorter_dist_js_jquery_tablesorter_js__ = __webpack_require__("./node_modules/tablesorter/dist/js/jquery.tablesorter.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_tablesorter_dist_js_jquery_tablesorter_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_tablesorter_dist_js_jquery_tablesorter_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_tablesorter_dist_css_theme_bootstrap_4_min_css__ = __webpack_require__("./node_modules/tablesorter/dist/css/theme.bootstrap_4.min.css");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_tablesorter_dist_css_theme_bootstrap_4_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_tablesorter_dist_css_theme_bootstrap_4_min_css__);
	...
	/*********************** open WP in finder + open PhpMyAdmin  + open WP-ADMIN***********************/
     	$(".update-tabs tr").on("click", function(e){
     		...
     		if($(tr).find("td:eq(0) i").hasClass("fa-file")){
     			Object(__WEBPACK_IMPORTED_MODULE_1__run_finder_js__["a" /* runFinder */])(txt);
     			...
     			Object(__WEBPACK_IMPORTED_MODULE_3__run_bash_js__["a" /* runBash */])("wp admin  --path=" + wpPath);
     	...
     	$("#btn_backup_wp").on("click", function(e){
     		...
     		Object(__WEBPACK_IMPORTED_MODULE_4__editwp_backup_js__["a" /* swal_backup */])(wpPath, DBname);
     	});
     	...
     	$("#btn_del_wp").on("click", function(e){
     		...
     		var DBname=$(".update-tabs tr:eq(1) td:eq(1)").text();
     		Object(__WEBPACK_IMPORTED_MODULE_5__editwp_delete_js__["a" /* swal_delete */])(wpName, wpPath, DBname);
     	});
...
function LoadEditTab(theTab, wpPath){
...
function loadMe(theTab, what="home"){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editwp_js__ = __webpack_require__("./src/editwp.js");
...
$(document).on("change", "#lang-select", function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])(cmd);
...
$(document).on("click","button[name=btn-del-debug-single]", function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp config delete " + debug + " --path=" + wpPath + " --type=constant");
	runDebugValues(e, "get");
});
...
$(document).on("change","input[data-config='debug']", function(e){
	...
	var wpPath=$(".update-tabs tr:eq(0) td:eq(1)").text();
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp config set " + debug + " " + valyu + " --type=constant --raw --path=" + wpPath );
	runDebugValues(e, "get");
});
...
$(document).on("click","table[id^='table-options-'] button", function(e){
	...
	var status=Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])(cmd);
	$(e.target).toggleClass('fa-spin fa-2x');
	if(status){
		swal({
			title:"updated",
...
$(document).on("dblclick","[id^=table-plugins-] tbody tr td:nth-child(2)",function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin get " + plugin + " --format=json --path="+wpPath).done(function(status,output){
...
$(document).on("click", "button[name='btn-plugins-update']", function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin update "+plugin+" --path="+wpPath).done(function(status,output){
		if(status===0){
			swal(plugin,output,"success", {timer:2000, buttons:false}).then(()=>{
				Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("plugins",theTabb);
			});
		} else {
...
$(document).on("click","button[name='btn-plugins-delete']", function(e){
	...
	var wpPath=$(e.target).attr("data-path");
		...
		swal({
			...
			if(value){
				Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin delete "+plugin+" --path="+wpPath).done(function(status, output){
				if(status===0){
					swal(plugin,output,"success", {timer:2000, buttons:false}).then(()=>{
						Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("plugins",theTabb);
					});
...
$(document).on("click","button[name='btn-plugins-install']", function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin install "+plugin+"  --path="+wpPath).done(function(status,output){
		if(status===0){
...
$(document).on("click","[id^=btn-select-plugins-]", function(e){
	...
	switch(parseInt(VaL)){
		case 1:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin activate "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
		...
		break;
		case 2:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin deactivate "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
		...
		break;
		case 3:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin install "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
		...
		break;
		case 4:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin update "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
		...
		break;
		case 5:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin delete "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
...
$(document).on("dblclick","[id^=table-plugins-] tbody tr td:nth-child(3)", function(e){
	...
	if(status=="active" || status=="inactive"){
		...
		Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp plugin toggle "+plugin+" --path="+wpPath).done(function(exit, output){
			if(exit===0){
...
$(document).on("dblclick","[id^=table-themes-] tbody tr td:nth-child(2)",function(e){
	...
	var wpPath=$("table.update-tabs tbody tr:eq(0) td:eq(1)").text();
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme get " + theme + " --format=json --path="+wpPath).done(function(status,output){
...
$(document).on("click", "button[name='btn-themes-update']", function(e){
	...
	var wpPath=$(e.target).attr("data-path");
	var thisTD=$(e.target).closest("td");
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme update "+theme+" --path="+wpPath).done(function(status,output){
		if(status===0){
			swal(theme,output,"success", {timer:2000, buttons:false}).then(()=>{
				Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("themes",theTabb);
			});
		} else {
			swal("ooops",output,"error");
		}
...
$(document).on("click","button[name='btn-themes-delete']", function(e){
	...
	var wpPath=$(e.target).attr("data-path");
		...
		swal({
			...
			if(value){
				Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme delete "+theme+" --path="+wpPath).done(function(status, output){
				if(status===0){
					swal(theme,output,"success", {timer:2000, buttons:false}).then(()=>{
						Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("themes",theTabb);
					});
...
$(document).on("click","button[name='btn-themes-install']", function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme install "+theme+"  --path="+wpPath).done(function(status,output){
		if(status===0){
...
$(document).on("click","[id^=btn-select-themes-]", function(e){
	...
	switch(parseInt(VaL)){
		case 3:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme install "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
					swal("all installed",output,"success",{buttons:false,timer:2000}).then(()=>{
						Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("themes",theTabb);
					});
		...
		break;
		case 4:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme update "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
					swal("all updated",output,"success",{buttons:false,timer:2000}).then(()=>{
						Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("themes",theTabb);
					});
		...
		break;
		case 5:
			Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme delete "+ps+" --path="+wpPath).done(function(status,output){
				if(status===0){
					swal("all deleted",output,"success",{buttons:false,timer:2000}).then(()=>{
						Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("themes",theTabb);
					});
...
$(document).on("dblclick","[id^=table-themes-] tbody tr td:nth-child(3)", function(e){
	...
	if(status=="active" || status=="inactive"){
		...
		Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp theme activate "+theme+" --path="+wpPath).done(function(exit, output){
			if(exit===0){
...
$(document).on("dblclick", "#users-list table tbody tr", function(e){
	...
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])("wp user meta list "+user+" --format=json --path="+wpPath).done(function(status, output){
		output=$.parseJSON(output);
		var msg="";
		var VaL="";
		$.each(output, function(i,v){
...
function updateUser(cmd){
	Object(__WEBPACK_IMPORTED_MODULE_0__run_bash_js__["a" /* runBash */])(cmd).done(function(status,output){
		if(status===0){
			swal("user updated!",output,"success",{buttons:false,timer:2000}).then(()=>{
				Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("users","admin");
			});
		} else {

			swal("ooops!",output,"error").then(()=>{Object(__WEBPACK_IMPORTED_MODULE_1__editwp_js__["loadMe"])("users","admin")});
		}
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = runDBdelete;
function runDBdelete(dbNAME){
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = runDBexport;
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = runWPlock;
function runWPlock(wpName, lock){
...
module.exports = __webpack_require__("./src/editwp.js");


/***/ })

},[4]);
//# sourceMappingURL=editwp.bundle.js.map